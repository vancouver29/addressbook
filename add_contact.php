...
//Run Query
$db->query("INSERT INTO contacts (first_name, last_name, email, phone, address1, address2, city, state, zipcode, notes, contact_group, date_added)
            VALUES (:first_name, :last_name, :email, :phone, :address1, :address2, :city, :state, :zipcode, :notes, :contact_group, :date_added)");
...
$db->bind(':date_added', $_POST['date_added']);
